...
public class m_log_entrys_adapter_main extends RecyclerView.Adapter<m_log_entrys_adapter_main.ViewHolder>
{
    ...
    public m_log_entrys_adapter_main(ArrayList datalist)
    {
                this.datalist = datalist;
    }
    @NonNull
    @Override
    public m_log_entrys_adapter_main.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        ...
        return  new m_log_entrys_adapter_main.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull m_log_entrys_adapter_main.ViewHolder holder, int position)
    {
    ...
    public void refresh_dataset(ArrayList data)
    {
        this.datalist.clear();
        this.datalist = data;
