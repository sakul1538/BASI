...
public class kamera_spinner<ID> extends SQLiteOpenHelper implements db_controlls,SQL_finals
{
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase)
    {
        ...
        sqLiteDatabase.execSQL("CREATE TABLE "+TB_MATERIAL_ZULIEFERER+" (ID TEXT,NAME TEXT)");
        sqLiteDatabase.execSQL("CREATE TABLE "+TB_MATERIAL_TYP+" (ID TEXT,NAME TEXT,EINHEIT TEXT)");
